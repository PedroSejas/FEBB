      ...
      try {
        ...
        setState(() {
          ...
          if (_isIos) {
            ...
            _errorMessage = 'Não há usuário cadastrado correspondente a esta identificação.';
        });
      }
    }
  }
  ...
  void _showVerifyEmailSentDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Validação da Conta"),
          content: new Text("Um link para validação da conta, foi enviado para seu email"),
          actions: <Widget>[
            new FlatButton(
              child: new Text("Ok"),
              onPressed: () {
  ...
  Widget _showSecondaryButton() {
    return new FlatButton(
      child: _formMode == FormMode.LOGIN
          ...
          : new Text('Já tem uma conta? Realize o Login',
          style:
